...
namespace Schedulefy.Data.Migrations
{
    ...
    [Migration("20250626094042_InitialMigrationCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Schedulefy.Data.Models.ScedulefyUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Schedulefy.Data.Models.ScedulefyUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Schedulefy.Data.Models.Event", b =>
                {
                    ...
                    b.HasOne("Schedulefy.Data.Models.ScedulefyUser", "Publisher")
                        .WithMany()
            ...
            modelBuilder.Entity("Schedulefy.Data.Models.UserEvent", b =>
                {
                    ...
                    b.HasOne("Schedulefy.Data.Models.ScedulefyUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
